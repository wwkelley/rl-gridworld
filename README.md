...
| exp02_find_reward | Agent learns to collect two adjacent resources from a random starting position | Tabular Q-Learning | experiments/tabular_q/experiment_02_find_reward |
